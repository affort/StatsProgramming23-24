...
This individual assessment is for the MATH11176 Statistical Programming course for the 2023/24 academic year.
...
An Rmarkdown version of the code is in `SP_code_TWY.rmd`; the output of the thin plate spline function can be seen on page 12 of `SP_code_TWY.pdf`.
...
I received a score of 18/23 marks (a distinction) for this code.
